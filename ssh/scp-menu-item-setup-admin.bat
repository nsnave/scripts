...
REG ADD "HKEY_CLASSES_ROOT\Directory\shell\%menutext%\command" /d "%command2%" /f
REG ADD "HKEY_CLASSES_ROOT\Directory\Background\shell\%menutext%\command" /d "%command2%" /f
